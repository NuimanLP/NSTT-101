    ...
    <div style={{marginBottom: '20px'}}></div>
      ...
      <div  style={{ display: 'flex' }}>
        <div className='hightlight' style={{marginLeft:'50px'}}>
          ...
          <div className='texthigthlight' style={{marginTop: '10px',marginLeft: '13px',fontSize:'17px'}}>{data.attributes.Category}</div>
        </div>
        ...
        <div className='hightlight' style={{marginLeft:'70px'}}>
          ...
          <div className='texthigthlight' style={{marginTop: '1px',marginLeft: '18px'}}>คะแนนที่พัก<div style={{marginLeft:'25px'}}>{data.attributes.Star}/5</div></div>
          <div></div>
        </div>
        <div className='hightlight' style={{marginLeft:'70px'}}>
